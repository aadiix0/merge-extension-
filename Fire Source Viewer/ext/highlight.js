! function(e) {
    ...
    function c(e) {
        ...
        p(f) || (h.useBR ? (n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).textContent = e.textContent.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : n = e, i = n.textContent, r = f ? C(f, i, !0) : O(i), (t = M(n)).length && ((a = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).textContent = r.value, r.value = function(e, n, t) {
            var r = 0,
                a = "",
                i = [];
        ...
        }(t, M(a), i)), r.value = B(r.value), e.textContent = r.value, e.className = (c = e.className, o = f, u = r.language, s = o ? g[o] : u, l = [c.trim()], c.match(/\bhljs\b/) || l.push("hljs"), -1 === c.indexOf(s) && l.push(s), l.join(" ").trim()), e.result = {
            language: r.language,
            re: r.r
